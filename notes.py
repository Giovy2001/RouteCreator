...
TODO: Update #3 - Rework Route creation
    ...
    [ ] Sistema css delle tre fasi di route creation
        [ ] Aggiungi i tre pallini indicatori della fase
        [ ] Trovare un modo per far stare tutte opzioni durante la fase di create_route (per via dello scroll bloccato)
...
TODO: Update #4 - qol features
    
    [ ] Possibilità di filtrare nell'index, per autore / nome
        [ ] Singola barra di ricerca filtra qualsiasi risultato coerente
